...
export const MOCK_REQUESTS: ClassroomRequest[] = [
  // FIX: Replaced setHours and setMinutes with set
  { id: 1, userId: 1, subject: 'Clase de Consulta', career: 'Ingeniería en Informática', startTime: set(addDays(now, 3), { hours: 18, minutes: 0 }), endTime: set(addDays(now, 3), { hours: 19, minutes: 0 }), reason: 'Preparación para parcial.', status: RequestStatus.PENDIENTE, requestedClassroomId: 4 },
